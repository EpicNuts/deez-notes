      ...
      <div className="mt-4 flex flex-col gap-8">
        ...
        >
          <Textarea
            ...
            className="placeholder:text-muted-foreground resize-none rounded-none border-none bg-transparent p-0 shadow-none focus-visible:ring-0 focus-viible:ring-offset-0"
            style={{
              minHeight: "0",
              lineHeight: "normal",
            }}
